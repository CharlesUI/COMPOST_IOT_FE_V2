...
const Settings = () => {
  ...
  useEffect(() => {
    if (adminClickCount === 5 && !isLoggingOut) {
      // Added check for isLoggingOut
      console.log("See if this is the issue when logging out");
  ...
  }, [adminClickCount, router, isLoggingOut]);
    ...
    <View className="flex-row justify-between items-center py-3 border-b border-[#4B4747]">
      ...
      {isButton ? (
        <Pressable
          ...
          className="bg-[#4B4747] px-3 py-1 rounded-lg"
        >
          ...
          <View className="bg-[#2F2C2C] rounded-lg p-4">
            ...
            <View className="py-4 border-b border-[#4B4747]">
              ...
              <Text className="text-white">
                ...
                Thermal Energy Conversion to Electricity from Composting of Food
